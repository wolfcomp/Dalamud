...
internal sealed class SettingsTabAutoUpdates : SettingsTab
{
    ...
    public override void Draw()
    {
        ...
        ImGuiHelpers.TextColoredWrapped(ImGuiColors.DalamudWhite, Loc.Localize("DalamudSettingsAutoUpdateBehavior",
        ...
        if (this.behavior == AutoUpdateBehavior.UpdateAll)
        {
            ...
            ImGuiHelpers.TextColoredWrapped(ImGuiColors.DalamudOrange, warning);
        }
        ...
        ImGuiHelpers.TextColoredWrapped(ImGuiColors.DalamudGrey, Loc.Localize("DalamudSettingsAutoUpdatePeriodicallyHint",
        ...
        ImGuiHelpers.TextColoredWrapped(ImGuiColors.DalamudWhite, Loc.Localize("DalamudSettingsAutoUpdateOptedIn",
                                                                               "Per-plugin overrides"));

        ImGuiHelpers.TextColoredWrapped(ImGuiColors.DalamudWhite, Loc.Localize("DalamudSettingsAutoUpdateOverrideHint",
